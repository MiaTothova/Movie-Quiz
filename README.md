...
## Content
* Main quiz idea has come from this youtube tutorial. 
[Web Dev Simplified](https://www.youtube.com/watch?v=riDzcEQbX6k) I have customized most of the functions given and added my own functionality to the quiz.
* I have also watched and practiced this tutorial. the way he explains each function has helped me understand the functionality of the code. I was able to make changes to my original code and implement the score counting in my own quiz. [GreatStack](https://www.youtube.com/watch?v=PBcqGxrr9g8)
* List of questions in the application have been generated by ChadGPT. [ChadGPT](https://chat.openai.com/)  
* All images were found using the Google image search engine [Google](https://www.google.com/)  
* I have used Stack overflow to reasearch most of my coding issues[StackOverflow](https://stackoverflow.com/)

## Credits
* Roo from student tutoring for helping me solve my image issues.
* My mentor Rahul Lakhanpal for his feedback and support.
